...
def test_refresh_indicators_writes_ma(db_conn, patch_db_path):
    ...
    from twstock.strategy.indicators import refresh_indicators
...
def test_ensure_indicators_idempotent(db_conn, patch_db_path):
    ...
    db_conn.execute("UPDATE stock_indicators SET ma200 = 100.0 WHERE stock_id = '2330'")
    db_conn.commit()
