...
def test_scan_excludes_below_min_volume():
    ...
    a = '9001'
    closes = [10 + i * 0.1 for i in range(205)]
    vols_a = [600000] * 204 + [4000]  # last day low
    ...
    conn.execute('INSERT INTO stock_indicators (stock_id, date, ma200, ma60) VALUES (?, ?, ?, ?)', (a, dates[-1], 100.0, 100.0))
    ...
    conn.execute('INSERT INTO stock_indicators (stock_id, date, ma200, ma60) VALUES (?, ?, ?, ?)', (b, dates[-1], 100.0, 100.0))
    conn.commit()
