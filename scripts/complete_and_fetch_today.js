...
async function run() {
  ...
  // 2.1 TWSE Quotes
  try {
    const twseUrl = `https://www.twse.com.tw/exchangeReport/MI_INDEX?response=json&date=20260615&type=ALL`;
  ...
  try {
    const twseInstUrl = `https://www.twse.com.tw/rwd/zh/fund/T86?response=json&date=20260615&selectType=ALLBUT0999`;
